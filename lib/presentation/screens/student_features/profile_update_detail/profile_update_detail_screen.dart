...
class ProfileUpdateDetailScreen extends StatelessWidget {
  static const String routeName = '/profile-update-detail-student';
    ...
    return MaterialPageRoute(
      builder:
          (_) => BlocListener<AuthenticationBloc, AuthenticationState>(
            ...
            child: ProfileUpdateDetailScreen(studentModel: studentModel),
          ),
  ...
  const ProfileUpdateDetailScreen({super.key, required this.studentModel});
