...
class BodyVoucherHistory extends StatefulWidget {
  const BodyVoucherHistory({super.key, required this.studentId});

  final String studentId;

  @override
  State<BodyVoucherHistory> createState() => _BodyVoucherHistoryState();
}

class _BodyVoucherHistoryState extends State<BodyVoucherHistory> {
  ...
  void initState() {
    ...
    context.read<StudentBloc>().add(
      LoadVoucherTransactions(id: widget.studentId),
    );

    scrollController.addListener(() {
      if (scrollController.position.pixels ==
          scrollController.position.maxScrollExtent) {
        context.read<StudentBloc>().add(LoadMoreVoucherTransactions(scrollController));
      }
    });
  }
