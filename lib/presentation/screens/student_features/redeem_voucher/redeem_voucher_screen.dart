      ...
      child: BlocListener<InternetBloc, InternetState>(
        ...
        child: SafeArea(
          child: Scaffold(
            ...
            body: BlocListener<RedeemVoucherBloc, RedeemVoucherState>(
              listener: (context, state) {
            ...
            bottomNavigationBar: BottomAppBar(
              ...
              height: 80 * hem,
              elevation: 5,
              child: BlocBuilder<RedeemVoucherBloc, RedeemVoucherState>(
                builder: (context, state) {
                  final isLoading = state is RedeemVoucherLoading;
                        ...
                        Center(
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: isLoading ? null : klightPrimaryColor,
